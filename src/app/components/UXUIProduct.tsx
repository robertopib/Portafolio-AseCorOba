      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <p className="text-base text-neutral-300 mt-4 mb-4 max-w-2xl">
          {language === 'es'
            ...
            : 'User-centered digital experience design'}
        </p>
        <div className="mb-12 max-w-2xl">
          ...
          <p className="text-base text-neutral-400">
            {language === 'es'
              ? 'Trabajo en diseño de producto digital aplicando metodologías UX: research, definición de flujos, prototipado y testing para optimizar la experiencia del usuario.'
              : 'Work in digital product design applying UX methodologies: research, flow definition, prototyping and testing to optimize user experience.'}
          </p>
        </div>
        ...
        <div className="flex justify-center mt-12">
          ...
          >
            <span>{language === 'es' ? 'Ver más proyectos UX/UI' : 'View more UX/UI projects'}</span>
