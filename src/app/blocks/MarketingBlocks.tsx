 ...
 * src/app/pages/Marketing360Projects.tsx. Data from
 * content/sections/marketing-360.json.
 */
...
export function MarketingHeader({ content }: { content?: HeaderContent }) {
  ...
  const sectionNumber = content?.sectionNumber ?? "06";
  const title = content?.title ?? marketing360.page.title;
  const description = content?.description ?? marketing360.page.description;
